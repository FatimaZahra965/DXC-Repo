...
export function createNewContratAction(contrat) {
  ...
  return (dispatch) => {
    ...
    clienteAxios
      .post("https://localhost:9003/DXC/contrats/addContrat", contrat)
      .then((res) => {
        console.log(res);
...
export function getContratsAction() {
  return (dispatch) => {
    ...
    // interroger l'API
    clienteAxios
      .get("https://localhost:9003/DXC/contrats/allContrats")
      .then((resp) => {
        //console.log(resp);
...
export function getContratAction(id) {
  return (dispatch) => {
    ...
    clienteAxios
      .get(`https://localhost:9003/DXC/contrats/Contrat/${id}`)
      .then((resp) => {
...
export function editContratAction(contrat) {
  return (dispatch) => {
    ...
    clienteAxios
      .put(`https://localhost:9003/DXC/contrats/updateContrat`, contrat)
      .then((resp) => {
        //console.log(resp);
